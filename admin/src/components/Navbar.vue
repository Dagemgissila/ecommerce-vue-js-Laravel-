                ...
                <MenuItems
                    ...
                    <div class="px-1 py-1">
                        ...
                        <button @click="logout" :class="[
                            ...
                            <ArrowRightStartOnRectangleIcon :active="active" class="mr-2 h-5 w-5 text-indigo-400" aria-hidden="true" />
                            Logout
                        </button>
                        </MenuItem>
                    </div>
...
<script setup>
import { Bars3Icon ,ArrowRightStartOnRectangleIcon,UserCircleIcon} from '@heroicons/vue/24/outline';
